...
* @returns {string}
*/
export function generate_svg(jsongraph, settings) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(jsongraph, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.generate_svg(retptr, ptr0, len0, addHeapObject(settings));
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('fdg-img_bg.wasm', import.meta.url);
    }
    const imports = getImports();

...
function step() {
    ...
    sim.edges.forEach((edge) => {
        ...
        context.beginPath();
        context.moveTo((source.location[0] * zoom) + centerX, (source.location[1] * zoom) + centerY);
        context.lineTo((target.location[0] * zoom) + centerX, (target.location[1] * zoom) + centerY);

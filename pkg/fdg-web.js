...
export class ForceGraphEdge {
    ...
    */
    get source() {
        try {
            ...
            wasm.forcegraphedge_source(retptr, this.ptr);
    ...
    */
    get target() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.forcegraphedge_target(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
export class ForceGraphSimulator {
    ...
    */
    location_from_name(name) {
        try {
            ...
            const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.forcegraphsimulator_location_from_name(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v1;
            if (r0 !== 0) {
    ...
    */
    setNodeLocationFromName(name, location) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(location, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.forcegraphsimulator_setNodeLocationFromName(this.ptr, ptr0, len0, ptr1, len1);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('fdg-web_bg.wasm', import.meta.url);
    }
    const imports = getImports();
